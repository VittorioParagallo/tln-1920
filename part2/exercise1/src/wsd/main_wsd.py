...
def lesk_algorithm(word, context):
    ...
    def compute_overlap(ctx1, ctx2): return len(set(ctx1) & set(ctx2))
    # get the signature of a sense
    def sense_details(syn): return preprocess(
...
# return a list of triple (goldSyn, word_to_wsd, text_sent)
